...
class ConversationalRAG:
    ...
    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        ...
        try:
            ...
            self.log.info("RAG chain invoked successfully", user_input=user_input, session_id=self.session_id, answer_preview=answer[:150]),
            return answer
    ...
    def _build_lcel_chain(self):
        try:
            ...
            self.log.error("Error building LCE chain", error=str(e))
