...
# --- Global logger instance for all modules ---
GLOBAL_LOGGER = CustomLogger().get_logger(__file__)


# --- Usage Example ---
if __name__ == "__main__":
    GLOBAL_LOGGER.info("User uploaded a file", user_id=123, filename="report.pdf")
    GLOBAL_LOGGER.error("Failed to process PDF", error="File not found", user_id=123)
