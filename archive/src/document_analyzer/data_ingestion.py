...
class DocumentHandler:
    ...
    def __init__(self,data_dir=None,session_id=None):
        try:
            ...
            self.log.info("PDFDocumentHandler initialized", session_id=self.session_id, session_path=self.session_path)
    ...
    def save_pdf(self, uploaded_file):
        try:
            ...
            self.log.info("PDF saved sucessfully", file=filename, save_path=save_path, session_id=self.session_id)
            return save_path
    ...
    def read_pdf(self, pdf_path:str) ->str:
        try:
            ...
            self.log.info("PDF read sucessfully", pdf_path=pdf_path, session_id=self.session_id, page=len(text_chunks)) 
            return text          
        except Exception as e:
...
if __name__ == "__main__":
    ...
    try:
        saved_path = handler.save_pdf(dummy_pdf)  # ✅ fixed typo: handler not savehandler
        print(saved_path)
